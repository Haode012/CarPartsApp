...
class CarPartsCategoryFilter: Filter {

    //arrayList in which we want to search
    private var filterList: ArrayList<CarPartsCategoryModel>

    //adapter in which filter need to be implemented
    private var carPartsCategoryAdapter: CarPartsCategoryAdapter

    //constructor
    constructor(
        filterList: ArrayList<CarPartsCategoryModel>,
        carPartsCategoryAdapter: CarPartsCategoryAdapter
    ) : super() {
        this.filterList = filterList
        this.carPartsCategoryAdapter = carPartsCategoryAdapter
    }
    ...
    override fun publishResults(constraint: CharSequence?, results: Filter.FilterResults) {
        ...
        carPartsCategoryAdapter.carPartsCategoryModelArrayList= results.values as ArrayList<CarPartsCategoryModel>
        //notify changes
        carPartsCategoryAdapter.notifyDataSetChanged()
    }
}