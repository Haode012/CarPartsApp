...
import tarc.edu.carpartsapp.databinding.FragmentReturnProductCreditCardBinding

class ReturnProductCreditCardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentReturnProductCreditCardBinding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.editTextSearch.addTextChangedListener(object: TextWatcher {
            ...
            override fun onTextChanged(s: CharSequence?, p1: Int, p2: Int, p3: Int) {
                ...
                try{
                    returnProductCreditCardAdapter.filter.filter(s)
                }
                catch (e: Exception){
